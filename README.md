...
It models the flow of goods, costs, and demand across multiple nodes (suppliers → factory → warehouses → retailers), with the goal of building a realistic dataset that can be used for:
...
> All commands should be run inside the project folder:  
